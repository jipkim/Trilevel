...
using JuMP, KNITRO
using Distributions
function SP(testsystem, s, kappa, timeset, PdownMax, η, σ0_pv, σ0_wind, υ0, Dπ, tau_e, tau_c, RegGap, UserGap, α0inv, π0)
   ScaleObj = 1e-5
   ...
   #----------------------#
   #:::::|||| Lower-level Strond Duality constraints |||| :::::#
   ...
   #----------------------#
   #### constraint for checking result
